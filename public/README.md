# Resident Cleaning Service - Wing Application

This directory contains the Wing language application (`app.w`) for the Resident Cleaning Task Management system.

## About app.w

`app.w` is a cloud-native application written in [Wing](https://www.winglang.io/), a programming language for the cloud. Wing allows you to define both your cloud infrastructure and application logic in a single file.

## What's Inside

The `app.w` file defines a complete REST API for managing residential cleaning tasks and bookings with the following endpoints:
...
```bash
# For AWS
wing compile --target tf-aws public/app.w
terraform init
terraform apply
...
- [Wing GitHub Repository](https://github.com/winglang/wing)
- [Wing Examples](https://github.com/winglang/examples)

## Note

This is a cloud application file (.w extension) for the Wing programming language, not the previous JavaScript-based implementation. The `.wz` extension mentioned in some references is a typo - Wing files use `.w` extension.
